...
<div class="comment_detail">
	<ul>
		...
		<?php if (!empty($restaurant->features)) {
			...
			<div class="fenxiang show"><a class="sina" href="http://service.weibo.com/share/share.php?url=http://www.laotangguan.com&pic=<?php echo 'http://www.laotangguan.com'.$restaurant->image_url;?>&title=原来汤馆也可以这么玩，快来看看我已经对【<?php echo $restaurant->name; ?>】打过分了&appkey=3495571392&ralateUid=" target="_blank"><i class="fa fa-share"></i> 分享</a></div>
