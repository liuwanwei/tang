...
class RestaurantTypeController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['RestaurantType'];
			if($model->save())
	...
	{
		$model=new RestaurantType('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['RestaurantType']))
			$model->attributes=$_GET['RestaurantType'];
	...
	{
		$model=RestaurantType::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param RestaurantType $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='restaurant-type-form')
		{
